...
class Ui_Companies(object):
    def setupUi(self, Companies):
        ...
        self.label.setGeometry(QtCore.QRect(185, 10, 170, 20))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(120, 10, 550, 33))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(190, 70, 300, 50))
    ...
    def retranslateUi(self, Companies):
        ...
        self.lb_borrowed.setText(_translate("Companies", "Debt list"))
        self.lb_lent.setText(_translate("Companies", "Lending list"))
        self.btn_submit_trans.setText(_translate("Companies", "Confirm"))
        self.btn_reset_trans.setText(_translate("Companies", "Reset"))
        self.lb_amount_trans.setText(_translate("Companies", "Amount"))
        self.lb_date_trans.setText(_translate("Companies", "Deadline"))
        self.lb_lent_2.setText(_translate("Companies", "Lending list"))
        self.lb_borrowed_2.setText(_translate("Companies", "Debt list"))
        self.label_2.setText(_translate("Companies", "Debt"))
        self.lb_from_pur.setText(_translate("Companies", "Seller"))
        self.lb_amount_pur.setText(_translate("Companies", "Amount"))
        self.lb_date_pur.setText(_translate("Companies", "Repayment term"))
        self.btn_submit_pur.setText(_translate("Companies", "Confirm"))
        self.btn_reset_pur.setText(_translate("Companies", "Reset"))
        self.label.setText(_translate("Companies", "Finance"))
        self.lb_amount_finance.setText(_translate("Companies", "Amount"))
        self.lb_date_fin.setText(_translate("Companies", "Term"))
        self.btn_submit_fin.setText(_translate("Companies", "Confirm"))
        self.btn_reset_fin.setText(_translate("Companies", "Reset"))
        self.btn_ok_repay.setText(_translate("Companies", "Confirm"))
        self.label_3.setText(_translate("Companies", "Select:"))
        self.btn_info.setText(_translate("Companies", "Information"))
        self.btn_transfer.setText(_translate("Companies", "Transfer"))
        self.btn_purchase.setText(_translate("Companies", "Debt"))
        self.btn_finance.setText(_translate("Companies", "Finance"))
        self.btn_repay.setText(_translate("Companies", "Repay"))
        self.btn_quit.setText(_translate("Companies", "Exit"))
        self.lb_total_b.setText(_translate("Companies", "Debt"))
        self.lb_total_l.setText(_translate("Companies", "Lend"))
